...
local listMusics = {
	...
	{name = "Montagem Tomada", Obj = 114727662468481},
...
GL1["ScrollList"].ScrollBarThickness = 4
GL1["ScrollList"].CanvasSize = UDim2.new(0, 0, 0, #listMusics * 25)
